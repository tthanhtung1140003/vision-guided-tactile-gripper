...
class MotionPanel:
    def __init__(self, parent, state, motion, path_engine, log_cb,
        ...
        self.group_pill = [
            ("log", 275,  80, 20, 50, "#4CF03D"),
            ("log", 275, 120, 20, 50, "#4CF03D"),
            ("log", 572,  80, 20, 50, "#4CF03D"),
            ("log", 572, 120, 20, 50, "#4CF03D"),
            ("log", 869,  80, 20, 50, "#4CF03D"),
            ("log", 869, 120, 20, 50, "#4CF03D"),
        ]
    ...
    def build(self):
        ...
        self.btn_motion = create_button_group(self.parent, self.group_motion, 120, 60)
