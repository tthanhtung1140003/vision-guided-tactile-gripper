...
class Plot3DPanel:
    ...
    def update(self, state, slider_pos, slider_view, slider_max):
        ...
        ax.xaxis.line.set_color("#34A3AA")
        ax.yaxis.line.set_color("#E38C56")
        ax.zaxis.line.set_color("#4593AF")
        ax.tick_params(axis="x", colors="#34A3AA")
        ax.tick_params(axis="y", colors="#E38C56")
        ax.tick_params(axis="z", colors="#4593AF")
...
class PlotControlsPanel:
    ...
    def __init__(self, parent, slider_pos):
        ...
        self.group_slider_direction = [
            ("vertical",   840, 349, 150, "#67BE71"),
            ("horizontal", 840, 559, 150, "#67BE71"),
        ]
        self.group_labels_plot = [
            ("Xs", 180, 232, 80, 30, 20, "0.00"),
            ("Ys", 180, 273, 80, 30, 20, "0.00"),
            ("Zs", 180, 314, 80, 30, 20, "0.00"),
        ]
